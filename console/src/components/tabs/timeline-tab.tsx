    ...
    <div className="space-y-2">
      ...
      <div className="divide-y divide-brand-border rounded-lg border border-brand-border overflow-hidden">
        {events.map((ev) => {
          ...
          return (
            <div key={ev.event_id} className="bg-[#0a0a14]">
              <button
              ...
              {isOpen && (
                <div className="px-4 pb-3">
                  <pre className="rounded-lg bg-[#080810] border border-brand-border p-3 text-xs font-mono text-[#00ffc8] overflow-auto max-h-60">
