...
export default function DevelopersTab() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {newKey && (
                <div className="bg-brand-surface border border-emerald-500/30 rounded-lg p-6 backdrop-blur-md">
                    ...
                    <div className="flex items-center gap-2">
                        <code className="flex-1 bg-black/40 border border-brand-border px-4 py-2 text-white font-mono rounded">
                            {newKey}
                        </code>
                        <button
                            onClick={handleCopy}
            ...
            <div className="bg-brand-surface border border-brand-border rounded-lg overflow-hidden backdrop-blur-md">
                ...
                {loading ? (
                    ...
                    <table className="w-full text-left text-sm">
                        <thead className="bg-black/20 text-brand-muted">
                            <tr>
                        ...
                        <tbody className="divide-y divide-brand-border">
                            {keys.map((k) => (
                                <tr key={k.id} className="hover:bg-black/10 transition-colors">
