...
const tiles = [
  {
    ...
    description:
      "Every state revision is traceable. Replay and delivery traces support explainability and compliance reviews.",
    imgSrc: "/illustrations/security_trace.png",
  ...
  },
  {
    ...
    imgSrc: "/illustrations/security_scope.png",
  ...
  },
  {
    ...
    imgSrc: "/illustrations/security_guardrails.png",
    Diagram: LogDiagram,
  },
];

export function MissionCriticalCompliance() {
  return (
      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          {badges.map((label) => (
            <span
              key={label}
              className="rounded-full border border-white/10 bg-white/[0.04] px-4 py-2 text-xs font-medium text-brand-muted backdrop-blur-sm"
            >
              {label}
            </span>
          ))}
